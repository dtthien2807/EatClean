                ...
                <div class="col-sm-8">
                    <div class="cart-products-block">
                        <div class="row">
                            <div class="col-sm-2">
                                <div class="cart-product-img">
                                    <a href="product-detail.php" title="Lemon"><img src="Public/images/shop/product-05.png" class="img-responsive" alt="Products"></a>
                                </div>
                            </div>
                            <div class="col-sm-7">
                                <div class="cart-product-dtl">
                                    <h5 class="cart-product-name"><a href="product-detail.php" title="Lemon">Lemon</a></h5>
                                    <div class="cart-parent-page"><a href="#" title="Food">Food</a> / Vegetable</div>
                                    <div class="shop-products-rating">
                                        <ul>
                                            <li><i class="fa fa-star"></i></li>
                ...
                <div class="col-sm-8">
                    <div class="cart-products-block">
                        <div class="row">
                            <div class="col-sm-2">
                                <div class="cart-product-img">
                                    <a href="product-detail.php" title="Berry"><img src="Public/images/shop/product-01.png" class="img-responsive" alt="Products"></a>
                                </div>
                            </div>
                            <div class="col-sm-7">
                                <div class="cart-product-dtl">
                                    <h5 class="cart-product-name"><a href="product-detail.php" title="Berry">Berry</a></h5>
                                    <div class="cart-parent-page"><a href="#" title="Food">Food</a> / Vegetable</div>
                                    <div class="shop-products-rating">
                                        <ul>
                                            <li><i class="fa fa-star"></i></li>
            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="cart-final-btn">
                        <a href="#" class="btn btn-default" title="Continue Shopping">Continue Shopping</a>
                    </div>
                </div>
                <div class="col-sm-4">
            ...
            <div id="product-dtl-slider" class="product-dtl-slider">
                ...
                <div class="item shop-products-block">
                    <div class="shop-products-img">
                        <a href="product-detail.php" title="<?php echo $value->product; ?>"><img src="Public/images/shop/product-06.png" class="img-responsive" alt="Product"></a>
                    </div>
